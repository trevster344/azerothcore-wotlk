...
enum ServerConfigs
{
    ...
    CONFIG_PLAYER_STEALTH_BREAK_ON_COMBAT,
    CONFIG_PLAYER_STEALTH_BLOCK_IN_COMBAT_CAST,
    CONFIG_PLAYER_DRUID_BLOCK_EAT_DRINK_SHAPESHIFT,
    CONFIG_PLAYER_STEALTH_ALLOW_SHADOWMELD_IN_COMBAT,
    CONFIG_PLAYER_STEALTH_SHADOWMELD_DIRECT_DAMAGE_WINDOW,
    CONFIG_PET_OUT_OF_COMBAT_HEALTH_REGEN,
